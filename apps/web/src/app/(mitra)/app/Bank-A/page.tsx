// apps/web/src/app/mitra/app/bank-a/page.tsx
'use client';

import { useState, useCallback, useEffect, useRef } from 'react';
import { useRouter } from 'next/navigation';
import { AiOutlineLock, AiOutlineCheckCircle, AiOutlineCloseCircle, AiOutlineLoading3Quarters, AiOutlineBank, AiOutlineUser, AiOutlineIdcard, AiOutlineCamera } from 'react-icons/ai';
import styles from './mitra-app-bank-a.module.css';

const partnerName = 'Bank A';
...
export default function MitraAppPage() {
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      // Fallback jika kamera tidak dapat diakses
      ...
      if (context) {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              router.push('/mitra/app/Bank-A/dashboard');
            }, 2000);
          }, 2000);
        }, 1500);
      }
  ...
  const handleCloseModal = useCallback(() => {
    setShowVerificationOptions(false);
    setShowLoginModal(false);
    setVerificationStatus('denied'); // Aksi menutup modal dianggap menolak verifikasi
  }, []);
  ...
  const renderVerificationContent = () => {
    switch (verificationStatus) {
      case 'idle':
        return (
          <>
            <h3 className={styles.cardTitle}>Verifikasi Identitas Anda</h3>
            <p className={styles.cardDescription}>
              Untuk pembukaan rekening, kami memerlukan verifikasi identitas.
            </p>
      ...
      case 'kyc-form':
        return (
          <div className={styles.regularKycForm}>
            <h3 className={styles.cardTitle}>Formulir KYC Biasa</h3>
            <p className={styles.cardDescription}>
              Isi data berikut untuk melanjutkan verifikasi secara manual.
            </p>
      ...
      case 'scan-wajah':
        return (
          <div className={styles.regularKycForm}>
            ...
            {selfiePhoto && (
              <button onClick={() => setVerificationStatus('requesting')} className={styles.kycSubmitButton}>
                Lanjut Verifikasi
              </button>
            )}
          </div>
  ...
  return (
    <div className={styles.appContainer}>
      <header className={styles.appHeader}>
        <div className={styles.appLogo}><AiOutlineBank /></div>
